...
#python Analysis/makeComparison_Data-AllMC_forJorge.py DoubleEG/ DYJetsPtBinned/ptBinnedScaled TTJets WZ ZZ WW WJets data DYJets TTJets WZ ZZ WW WJets False True "" -b > DoubleEG_forJorge
...
for regionName in regionNames:
	...
	for etaMassName in etaMassNames:
		...
		# else:
		plotDataAndMCHistosAndRatio("mass_multiLeptonMultiJets"+regionName, etaMassName+"_histo", dataInputFile, MCFileList, outputDir, suff, False, 0, 0, False, 0, 0, legendData, legendList, False, log, False, False, norm, colorList, xsecList, sumWeightsList, lumi, title="comparison", xTitle="m_{lljj}", yTitle="# Events")
