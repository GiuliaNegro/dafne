...
##python Analysis/makeComparison_Data-AllMC-new.py DoubleEG/ DYJetsPtBinned/DY50-400 TTJets WZ ZZ WW WJets data DYJets TTJets WZ ZZ WW WJets False True "" -b > DoubleEG-new
##python Analysis/makeComparison_Data-AllMC-new.py DoubleEG/ DYJetsPtBinned/DY50-100 TTJets WZ ZZ WW WJets data DYJets TTJets WZ ZZ WW WJets False True "" -b > DoubleEG-new

#python Analysis/makeComparison_Data-AllMC-new.py DoubleEG/ DYJetsPtBinned/ptBinnedScaled TTJets WZ ZZ WW WJets data DYJets TTJets WZ ZZ WW WJets False True "" -b > DoubleEG-new
#python Analysis/makeComparison_Data-AllMC-new.py DoubleEG/ DYJetsPtBinned/ptBinnedScaled TTJets WZ ZZ WW WJets data DYJets TTJets WZ ZZ WW WJets True True "_normArea" -b > DoubleEG_normArea-new
...
inputDir = "Distributions-Moriond17/MLMJwithSingleObjects/"+dataDir 

# outDir = "Comparisons-Moriond17/MLMJwithSingleObjects/"+dataDir+"data-allMCbkg"+suff+"/"
outDir = "Comparisons-Moriond17/MLMJwithSingleObjects/SingleEle/data-allMCbkg"+suff+"/"
suff = ""
...
legendList = [legendMC1, legendMC3, legendMC4, legendMC5, legendMC6]
colorList = [kYellow, kAzure+7, kMagenta+1, kBlue, kRed-4]#kOrange+10]#kViolet+7] 
xsecList = [1, 1, 1, 1, 1]
sumWeightsList = [1, 1, 1, 1, 1]   
...
for regionName in regionNames:
	...
	# dataInputFile = TFile(inputDir+"distributions_histos"+regionName+".root")
	dataInputFile = TFile(inputDir+"SingleEle/distributions_histos"+regionName+".root")
	...
	MCFileList = [MC1inputFile, MC3inputFile, MC4inputFile, MC5inputFile, MC6inputFile]
...
if dataDir == "DoubleEG/" or dataDir == "SingleMuon/":
	for TnPName in TnPNames:

		# fileData = TFile(inputDir+"/distributions_histos"+TnPName+".root")
		fileData = TFile(inputDir+"SingleEle/distributions_histos"+TnPName+".root")
		file1 = TFile(inputDir+MC1dir+"/distributions_histos"+TnPName+".root")
		# file2 = TFile(inputDir+MC2dir+"/distributions_histos"+TnPName+".root")
		file3 = TFile(inputDir+MC3dir+"/distributions_histos"+TnPName+".root")
		file4 = TFile(inputDir+MC4dir+"/distributions_histos"+TnPName+".root")
		file5 = TFile(inputDir+MC5dir+"/distributions_histos"+TnPName+".root")
		file6 = TFile(inputDir+MC6dir+"/distributions_histos"+TnPName+".root")
		# ZMCFileList = [file1,file2,file3,file4,file5,file6]
		ZMCFileList = [file1, file3,file4,file5,file6]

		outputDir = outDir+TnPName

		etaMassNames = ["", "_EB-EB", "_EE-EE", "_EB-EE", "_noEB-EB"]

		Znames = ["toEE_MLMJelectrons"]#,"toEE_electrons"]
		if dataDir == "SingleMuon/":
			Znames = ["toMuMu_MLMJmuons"]#,"toMuMu_muons"]

		for Zname in Znames:
			for etaMassName in etaMassNames:
				plotDataAndMCHistosAndRatio("Z"+Zname+TnPName+"_mass", etaMassName+"_histo", fileData, ZMCFileList, outputDir, suff, True, 70, 110, False, 0, 0, legendData, legendList, False, log, False, False, norm, colorList, xsecList, sumWeightsList, lumi, title="comparison", xTitle="m_{ll}", yTitle="# Events")	
			
			plotDataAndMCHistosAndRatio("Z"+Zname+TnPName+"_pt", "_histo", fileData, ZMCFileList, outputDir, suff, False, 0, 0, False, 0, 0, legendData, legendList, False, log, False, False, norm, colorList, xsecList, sumWeightsList, lumi, title="comparison", xTitle="pT_{ll}", yTitle="# Events")	



# dataInputFile = TFile(inputDir+"distributions_histos.root")
dataInputFile = TFile(inputDir+"SingleEle/distributions_histos.root")
