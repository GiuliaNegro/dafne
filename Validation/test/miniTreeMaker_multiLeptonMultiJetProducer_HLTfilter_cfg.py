...
process.source = cms.Source("PoolSource",fileNames=cms.untracked.vstring(
				...
				"/store/group/phys_higgs/cmshgg/sethzenz/flashgg/ReMiniAOD-03Feb2017-2_5_0-test/2_5_0/SingleElectron/ReMiniAOD-03Feb2017-2_5_0-test-2_5_0-v0-Run2016B-03Feb2017_ver2-v2/170213_113017/0000/myMicroAODOutputFile_1.root"
))



##  import MultiLeptonMultiJet producer
process.load("dafne.MicroAOD.flashggMultiLeptonMultiJet_cfi") 
...
process.flashggMultiLeptonMultiJet.ElectronTag = "flashggRandomizedEle"
...
process.fullSeq = cms.Sequence(process.flashggRandomizedEle * process.flashggUnpackedJets * process.flashggMultiLeptonMultiJet * process.jetCorrectorChain * process.flashggMultiLeptonMultiJetSystematics * process.analysisTree)  ##for microAOD without MLMJ
