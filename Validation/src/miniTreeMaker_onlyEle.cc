...
miniTreeMaker_onlyEle::miniTreeMaker_onlyEle( const ParameterSet &iConfig, TFileDirectory& fs, ConsumesCollector && cc ):
...
miniTreeMaker_onlyEle::~miniTreeMaker_onlyEle()
{
}
...
// ******************************************************************************************
void miniTreeMaker_onlyEle::beginJob()
{
	ngen = 0;
	ngenPre = 0;
	ndldj = 0;
...
// analyzer
//
void miniTreeMaker_onlyEle::analyze(const EventBase& evt)
{
...
// ******************************************************************************************
void miniTreeMaker_onlyEle::endJob() {
...
// ******************************************************************************************
void miniTreeMaker_onlyEle::initEventStructure() {
	// per-event tree:
	evInfo.run = -999;
	evInfo.event = -999.;
	evInfo.lumi = -999.;
