...
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY50-1/output_DYJetsToLL_Pt-50To100_amcatnloFXFX-v3_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/DY50-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/output_DYJets_miniTree-v1.root", outputDir+"/DYJetsPtBinned/prova", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/output_DYJets_miniTree-v2.root", outputDir+"/DYJetsPtBinned/prova2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/output_DYJets_miniTree-v3.root", outputDir+"/DYJetsPtBinned/prova3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/output_DYJets_miniTree.root", outputDir+"/DYJetsPtBinned/prova4", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY650-2/output_DYJetsToLL_Pt-650ToInf_amcatnloFXFX-ext1-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/prova4/DY650-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);


// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY50-1/output_DYJetsToLL_Pt-50To100_amcatnloFXFX-v3_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY50-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY50-2/output_DYJetsToLL_Pt-50To100_amcatnloFXFX-ext3-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY50-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY100-1/output_DYJetsToLL_Pt-100To250_amcatnloFXFX-v2_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY100-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY100-2/output_DYJetsToLL_Pt-100To250_amcatnloFXFX-ext1-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY100-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY100-3/output_DYJetsToLL_Pt-100To250_amcatnloFXFX-ext2-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY100-3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY250-1/output_DYJetsToLL_Pt-250To400_amcatnloFXFX-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY250-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY250-2/output_DYJetsToLL_Pt-250To400_amcatnloFXFX-ext1-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY250-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY250-3/output_DYJetsToLL_Pt-250To400_amcatnloFXFX-ext2-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY250-3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY400-1/output_DYJetsToLL_Pt-400To650_amcatnloFXFX-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY400-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY400-2/output_DYJetsToLL_Pt-400To650_amcatnloFXFX-ext1-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY400-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY400-3/output_DYJetsToLL_Pt-400To650_amcatnloFXFX-ext2-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY400-3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY650-1/output_DYJetsToLL_Pt-650ToInf_amcatnloFXFX-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY650-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY650-2/output_DYJetsToLL_Pt-650ToInf_amcatnloFXFX-ext1-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY650-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY650-3/output_DYJetsToLL_Pt-650ToInf_amcatnloFXFX-ext2-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY650-3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/output_DY50-100_miniTree.root", outputDir+"/DYJetsPtBinned/DY50-100", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DYJetsPtBinned/output_DY50-400_miniTree.root", outputDir+"/DYJetsPtBinned/DY50-400", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
...
// 	// makePlots_multiLeptonMultiJet(inputDir+"DoubleEG/output_DoubleEG_miniTree.root", outputDir+"/prova", false, signalEE, false, false, TnPEE, false);
...
// // hadd distributions_histos.root DY100-1/distributions_histos.root DY100-2/distributions_histos.root DY100-3/distributions_histos.root DY250-1/distributions_histos.root DY250-2/distributions_histos.root DY250-3/distributions_histos.root DY400-1/distributions_histos.root DY400-2/distributions_histos.root DY400-3/distributions_histos.root DY50-1/distributions_histos.root DY50-2/distributions_histos.root DY650-1/distributions_histos.root DY650-3/distributions_histos.root
// // hadd distributions_histos_TnPCR.root DY100-1/distributions_histos_TnPCR.root DY100-2/distributions_histos_TnPCR.root DY100-3/distributions_histos_TnPCR.root DY250-1/distributions_histos_TnPCR.root DY250-2/distributions_histos_TnPCR.root DY250-3/distributions_histos_TnPCR.root DY400-1/distributions_histos_TnPCR.root DY400-2/distributions_histos_TnPCR.root DY400-3/distributions_histos_TnPCR.root DY50-1/distributions_histos_TnPCR.root DY50-2/distributions_histos_TnPCR.root DY650-1/distributions_histos_TnPCR.root DY650-3/distributions_histos_TnPCR.root
// // hadd distributions_histos_lowMllCR.root DY100-1/distributions_histos_lowMllCR.root DY100-2/distributions_histos_lowMllCR.root DY100-3/distributions_histos_lowMllCR.root DY250-1/distributions_histos_lowMllCR.root DY250-2/distributions_histos_lowMllCR.root DY250-3/distributions_histos_lowMllCR.root DY400-1/distributions_histos_lowMllCR.root DY400-2/distributions_histos_lowMllCR.root DY400-3/distributions_histos_lowMllCR.root DY50-1/distributions_histos_lowMllCR.root DY50-2/distributions_histos_lowMllCR.root DY650-1/distributions_histos_lowMllCR.root DY650-3/distributions_histos_lowMllCR.root
