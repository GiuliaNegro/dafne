#include "dafne/Validation/interface/makePlots_onlyMultiLeptonMultiJet.h"
#include <TFile.h>
#include <TTree.h>
#include <TRandom3.h>
#include <TH1D.h>
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::Init(){
...
// **************** 
Int_t makePlots_onlyMultiLeptonMultiJet::GetEntry(Long64_t entry){
...
// **************** 
Long64_t makePlots_onlyMultiLeptonMultiJet::LoadTree(Long64_t entry){
...
// **************** 
TH1D* makePlots_onlyMultiLeptonMultiJet::newTH1D(string name, string title, string xTitle, int nBins, double xLow, double xUp){
...
// **************** 
TH2D* makePlots_onlyMultiLeptonMultiJet::newTH2D(string name, string title, string xTitle, string yTitle, int nBinsX, double xLow, double xUp, int nBinsY, double yLow, double yUp){
...
// **************** 
TProfile* makePlots_onlyMultiLeptonMultiJet::newTProfile(string name, string title, string xTitle, string yTitle, int nBinsX, double xLow, double xUp, double yLow, double yUp){
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::SetHistos(){
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::getLeadingElectrons(vector<eleStruct>& leadingElectrons){
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::getSubLeadingElectrons(vector<eleStruct>& subLeadingElectrons){
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::getLeadingMuons(vector<muonStruct>& leadingMuons){//, vector<muonStruct>& leadingMuonsRochCorr){
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::getSubLeadingMuons(vector<muonStruct>& subLeadingMuons){//, vector<muonStruct>& subLeadingMuonsRochCorr){
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::getLeadingJets(vector<jetStruct>& leadingJets){
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::getSubLeadingJets(vector<jetStruct>& subLeadingJets){
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::getMultiLeptonMultiJets(vector<multiLeptonMultiJetStruct>& multiLeptonMultiJets){
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::doEleDistributionsPlots(vector<eleStruct>& electrons, const int eleIdx, const int variableIdx, const int regionIdx) { 
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::doMuonDistributionsPlots(vector<muonStruct>& muons, const int muIdx, const int variableIdx, const int regionIdx) { 
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::doJetsDistributionsPlots(vector<jetStruct>& jets, const int jetIdx, const int variableIdx, const int regionIdx) { 
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::doElePlots(vector<eleStruct>& electrons, const int eleIdx, const int variableIdx, const int etaIdx){
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::doMassPlots(vector<multiLeptonMultiJetStruct>& multiLeptonMultiJets, const int mlmjIdx, const int regionIdx, const int etaMassIdx){
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::doZmassPlots(vector<multiLeptonMultiJetStruct>& multiLeptonMultiJets, const int mlmjIdx, const int variableIdx, const int etaIdx) { 	
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::Loop(){
	...
	// --Collections
		...
		// w = weight * nentries / 599665; //per DY-650-2  
...
// **************** 
void makePlots_onlyMultiLeptonMultiJet::saveHistosAndOutputFile(TString& ouputdir){
	// setTDRStyle();
	// writeExtraText = true; 
...
makePlots_onlyMultiLeptonMultiJet::makePlots_onlyMultiLeptonMultiJet(TString filename_, TString outputdir_, bool MC_, bool signalEE_, bool signalMuMu_, bool eMuSideband_, bool TnPEE_, bool TnPMM_):
...
void runmakePlots_onlyMultiLeptonMultiJet() {
	...
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/output_DYJetsPtBinned_miniTree.root", outputDir+"/DYJetsPtBinned", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY50-1/output_DYJetsToLL_Pt-50To100_amcatnloFXFX-v3_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/DY50-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/output_DYJets_miniTree-v1.root", outputDir+"/DYJetsPtBinned/prova", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/output_DYJets_miniTree-v2.root", outputDir+"/DYJetsPtBinned/prova2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/output_DYJets_miniTree-v3.root", outputDir+"/DYJetsPtBinned/prova3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/output_DYJets_miniTree.root", outputDir+"/DYJetsPtBinned/prova4", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY650-2/output_DYJetsToLL_Pt-650ToInf_amcatnloFXFX-ext1-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/prova4/DY650-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);


	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY50-1/output_DYJetsToLL_Pt-50To100_amcatnloFXFX-v3_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY50-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY50-2/output_DYJetsToLL_Pt-50To100_amcatnloFXFX-ext3-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY50-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

	makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY100-1/output_DYJetsToLL_Pt-100To250_amcatnloFXFX-v2_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY100-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY100-2/output_DYJetsToLL_Pt-100To250_amcatnloFXFX-ext1-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY100-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY100-3/output_DYJetsToLL_Pt-100To250_amcatnloFXFX-ext2-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY100-3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY250-1/output_DYJetsToLL_Pt-250To400_amcatnloFXFX-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY250-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY250-2/output_DYJetsToLL_Pt-250To400_amcatnloFXFX-ext1-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY250-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY250-3/output_DYJetsToLL_Pt-250To400_amcatnloFXFX-ext2-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY250-3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY400-1/output_DYJetsToLL_Pt-400To650_amcatnloFXFX-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY400-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY400-2/output_DYJetsToLL_Pt-400To650_amcatnloFXFX-ext1-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY400-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY400-3/output_DYJetsToLL_Pt-400To650_amcatnloFXFX-ext2-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY400-3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY650-1/output_DYJetsToLL_Pt-650ToInf_amcatnloFXFX-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY650-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY650-2/output_DYJetsToLL_Pt-650ToInf_amcatnloFXFX-ext1-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY650-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DYJetsPtBinned/DY650-3/output_DYJetsToLL_Pt-650ToInf_amcatnloFXFX-ext2-v1_dafne-Moriond17_miniTree.root", outputDir+"/DYJetsPtBinned/ptBinnedScaled/DY650-3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);



	// makePlots_onlyMultiLeptonMultiJet(inputDir+"TTJets/output_TTJets_miniTree.root", outputDir+"/TTJets", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

	// makePlots_onlyMultiLeptonMultiJet(inputDir+"WJets/output_WJetsToLNu_miniTree.root", outputDir+"/WJets", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

	// makePlots_onlyMultiLeptonMultiJet(inputDir+"WZ/output_WZ_miniTree.root", outputDir+"/WZ", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

	// makePlots_onlyMultiLeptonMultiJet(inputDir+"ZZ/output_ZZ_miniTree.root", outputDir+"/ZZ", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

	// makePlots_onlyMultiLeptonMultiJet(inputDir+"WW/output_WW_miniTree.root", outputDir+"/WW", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

	// makePlots_onlyMultiLeptonMultiJet(inputDir+"SingleTop/output_SingleTop_miniTree.root", outputDir+"/SingleTop", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);


	// makePlots_onlyMultiLeptonMultiJet(inputDir+"DoubleEG/output_DoubleEG_miniTree.root", outputDir, false, signalEE, false, false, TnPEE, false);

	// makePlots_onlyMultiLeptonMultiJet(inputDir+"SingleMuon/output_SingleMuon_miniTree.root", outputDir, false, false, signalMuMu, false, false, TnPMM);

	// makePlots_onlyMultiLeptonMultiJet(inputDir+"MuonEG/output_MuonEG_miniTree.root", outputDir, false, false, false, true, false, false);
...
#ifndef __CLING__
int main() {
  runmakePlots_onlyMultiLeptonMultiJet();
  return 0;
}
#endif