...
// 		// float gen_weight = (weight * sumWeights)/ (xs * puweight)

// 		// float gen_weight = (weight * 220) / (77.95 * puweight);   //per TT

// 		// float gen_weight = (weight * 920) / (346.7 * puweight);  //per DY50
		
// 		// float gen_weight = (weight * 190) / (81.3 * puweight);     //per DY100-1
// 		// float gen_weight = (weight * 200) / (81.3 * puweight);     //per DY100-2 e -3

// 		// float gen_weight = (weight * 6.8) / (2.98 * puweight);     //per DY250-1 e -3
// 		// float gen_weight = (weight * 7) / (2.98 * puweight);     //per DY250-2

// 		// float gen_weight = (weight * 0.88) / (0.3837 * puweight);     //per DY400-1 
// 		// float gen_weight = (weight * 0.89) / (0.3837 * puweight);     //per DY400-2
// 		// float gen_weight = (weight * 0.92) / (0.3837 * puweight);     //per DY400-3

// 		// float gen_weight = (weight * 0.085) / (0.03558 * puweight);     //per DY650-1
// 		// float gen_weight = (weight * 0.082) / (0.03558 * puweight);     //per DY650-2
// 		// float gen_weight = (weight * 0.087) / (0.03558 * puweight);     //per DY650-3

// 		// sumWeights += gen_weight;
// 		// continue;
...
// 		// w = (gen_weight * xs * puweight) / sumWeights;

// 		// w = (gen_weight * 77.95 * puweight) / 50107; //per TT

// 		// w = (gen_weight * 346.7 * puweight) / 212945; //per DY-50

// 		// w = (gen_weight * 81.3 * puweight) / 62780; //per DY-100-1
// 		// w = (gen_weight * 81.3 * puweight) / 18338.7; //per DY-100-2
// 		// w = (gen_weight * 81.3 * puweight) / 23095.3; //per DY-100-3
		

// 		// w = (gen_weight * 2.98 * puweight) / 129.905; //per DY-250-1

// 		// w = (gen_weight * 0.3837 * puweight) / 47.4453; //per DY-400-3

// 		// w = (gen_weight * 0.03558 * puweight) / 4.5814; //per DY-650-1
// 		// w = (gen_weight * 0.03558 * puweight) / 2.77016; //per DY-650-3
...
// 		// w = weight * nentries / 14529280; //per TT

// 		// w = (gen_weight * 346.7 * puweight) / 212945; //per DY-50

// 		w = weight * nentries / 2040596; //per DY-100-1
// 		// w = weight * nentries / 2950812; //per DY-100-2
// 		// w = weight * nentries / 2927633; //per DY-100-3
		

// 		// w = weight * nentries / 423976; //per DY-250-1

// 		// w = weight * nentries / 604038; //per DY-400-3

// 		// w = weight * nentries / 430691; //per DY-650-1
// 		// w = weight * nentries / 597526; //per DY-650-3
...
// 	// makePlots_multiLeptonMultiJet(inputDir+"DY-TT/output_DY50-2_miniTree.root", outputDir+"/DYJetsPtBinned/DY50-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

// 	makePlots_multiLeptonMultiJet(inputDir+"DY-TT/output_DY100-1_miniTree.root", outputDir+"/DYJetsPtBinned/DY100-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DY-TT/output_DY100-2_miniTree.root", outputDir+"/DYJetsPtBinned/DY100-2", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DY-TT/output_DY100-3_miniTree.root", outputDir+"/DYJetsPtBinned/DY100-3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

// 	// makePlots_multiLeptonMultiJet(inputDir+"DY-TT/output_DY250-1_miniTree.root", outputDir+"/DYJetsPtBinned/DY250-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

// 	// makePlots_multiLeptonMultiJet(inputDir+"DY-TT/output_DY400-3_miniTree.root", outputDir+"/DYJetsPtBinned/DY400-3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);

// 	// makePlots_multiLeptonMultiJet(inputDir+"DY-TT/output_DY650-1_miniTree.root", outputDir+"/DYJetsPtBinned/DY650-1", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
// 	// makePlots_multiLeptonMultiJet(inputDir+"DY-TT/output_DY650-3_miniTree.root", outputDir+"/DYJetsPtBinned/DY650-3", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
...
// 	// makePlots_multiLeptonMultiJet(inputDir+"DY-TT/output_TTJets_miniTree.root", outputDir+"/TTJets", true, signalEE, signalMuMu, eMuSideband, TnPEE, TnPMM);
