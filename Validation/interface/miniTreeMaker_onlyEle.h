...
class miniTreeMaker_onlyEle : public BasicAnalyzer 
{
 public:
	miniTreeMaker_onlyEle( const ParameterSet & iConfig, TFileDirectory& fs, ConsumesCollector && cc);
	virtual ~miniTreeMaker_onlyEle();
	void beginJob();
