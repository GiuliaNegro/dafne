#ifndef _makePlots_onlyMultiLeptonMultiJet_h_
#define _makePlots_onlyMultiLeptonMultiJet_h_
#include <iostream>
#include <fstream>
#include <cstdarg>
#include <vector>
...
class makePlots_onlyMultiLeptonMultiJet {
	public:
	...
	//definition of histos
		...
		makePlots_onlyMultiLeptonMultiJet(TString filename_, TString outputdir_, bool MC_, bool signalEE_, bool signalMuMu_, bool eMuSideband_, bool TnPEE_, bool TnPMM_);
